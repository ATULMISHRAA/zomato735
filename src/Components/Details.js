...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: "GET",
            url: `http://localhost:5656/restaurant/${restaurant}`,
    ...
    handleOrder = (resId) => {
        axios({
            method: "GET",
            url: `http://localhost:5656/menuitems/${resId}`,
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    getData=(data)=>{
        return fetch(`http://localhost:5656/payment`,{
            method:'POST',
            headers:{
    ...
    render() {
        ...
        return (
            ...
            <div>
                <div>
                    <img src={`./${restaurant.image}`} alt="No image ,sorry for the inconvinince" width="100%" height="350px" />
                    ...
                    <div>
                        ...
                        <Carousel
                            ...
                            {restaurant && restaurant.thumb && restaurant.thumb.map(item => {
                                return <div>
                                    <img src={`./${item}`} height="300px" width="200px" alt=""/>
